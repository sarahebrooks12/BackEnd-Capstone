...
namespace FamilyArchive.Controllers
{
    public class MembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,NickName,BirthDate,DeathDate,Anniversary,FamilyId,Pending")] Members members)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,NickName,BirthDate,DeathDate,Anniversary,FamilyId,Pending")] Members members)
        {
            if (id != members.Id)
            {
                return NotFound();
