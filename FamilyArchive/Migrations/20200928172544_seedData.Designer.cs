...
namespace FamilyArchive.Migrations
{
    ...
    [Migration("20200928172544_seedData")]
            ...
            modelBuilder.Entity("FamilyArchive.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "00000000-ffff-ffff-ffff-ffffffffffff", AccessFailedCount = 0, Address = "123 Lioness Way", ConcurrencyStamp = "37c3bdec-e95f-4010-a0b6-00b9290af3e5", Email = "rhonda@rhonda.com", EmailConfirmed = true, FamilyId = 1, FirstName = "Rhonda", IsAdmin = false, LastName = "Scragg", LockoutEnabled = false, PasswordHash = "AQAAAAEAACcQAAAAEKiAp7cNqYJkfgkoh/crgzPUli4bpVIuEEFVanZEh66whkkfseGGtjpIy7c0XSUDQw==", PhoneNumberConfirmed = false, TwoFactorEnabled = false, UserName = "lioness" }
                    );
                });
